...
env.git_code = "ssh://git@lab.admicro.vn:2317/gpdv/web-datphong.git"
...
node('Node_48.51') { 
	try {
        ...
        sh 'cd $web_release/$(tail -1 $release_note) && git checkout $(git describe --tags `git rev-list --tags --max-count=1`)'
